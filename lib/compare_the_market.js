...
const start = async config => {
    ...
    create_puppeteer(config.puppeteer)
        .then( async browser => {
            ...
            await page.click('#CarInsurance_YourVehicle_VehicleDetails_FindYourVehicle_Submit');
            await page.waitForFunction(
                () => document.querySelector('#CarInsurance_YourVehicle_VehicleDetails #CarInsurance_YourVehicle_VehicleDetails_FindYourVehicle') === null,
                {polling: 'mutation'}
            );
            progress_bar.update(2, {'step': 'Vehicle Details'});
            ...
            progress_bar.update(3, {'step': 'Vehicle Usage'});
            ...
            await page.click('#CarInsurance_YourVehicle_VehicleDetails_Section_Next');
            await page.waitForFunction(
                () => document.querySelector('#CarInsurance_YourVehicle_VehicleDetails_Section_Next') === null,
                {polling: 'mutation'}
            );
            ...
            // Progress to next section
            await page.click('#CarInsurance_YourVehicle_VehicleUsage_Section_Next');
            await page.waitForFunction(
                () => document.querySelector('#CarInsurance_YourVehicle_VehicleUsage_Section_Next') === null,
                {polling: 'mutation'}
            );
            progress_bar.update(4, {'step': 'Personal Details'});
            ...
            // Progress to next section
            await page.click('#CarInsurance_YourDetails_PersonalDetails_Section_Next');
            await page.waitForFunction(
                () => document.querySelector('#CarInsurance_YourDetails_PersonalDetails_Section_Next') === null,
                {polling: 'mutation'}
            );
            progress_bar.update(5, {'step': 'Additional Drivers'});
             ...
             * ===============
             */
            if (config.additional_drivers !== null) {
            ...
            // Progress to next section
            await page.click('#CarInsurance_YourDetails_AdditionalDrivers_Section_Submit');
            await page.waitForFunction(
                () => document.querySelector('#CarInsurance_YourDetails_AdditionalDrivers_Section_Submit') === null,
                {polling: 'mutation'}
            );
            progress_bar.update(6, {'step':'Policy Details'});
            ...
            // Progress to next section
            await page.click('#CarInsurance_YourPolicy_PolicyDetails_Section_Next');
            await page.waitForFunction(
                () => document.querySelector('#CarInsurance_YourPolicy_PolicyDetails_Section_Next') === null,
                {polling: 'mutation'}
            );
            progress_bar.update(7, {'step':'Additional Cover'});
            ...
            // Progress to next section
            await page.click('#CarInsurance_YourPolicy_AdditionalProductsAndFeatures_Section_Submit');
            await page.waitForFunction(
                () => document.querySelector('#CarInsurance_YourPolicy_AdditionalProductsAndFeatures_Section_Submit') === null,
                {polling: 'mutation'}
            );
            progress_bar.update(8, {'step':'Contact Methods'});
            ...
            // Progress to next section
            await page.click('#CarInsurance_YourPolicy_YourAccountAndContactDetails_Section_Submit');
            await page.waitForFunction(
                () => document.querySelector('#CarInsurance_YourPolicy_YourAccountAndContactDetails_Section_Submit') === null,
                {polling: 'mutation'}
            );
            progress_bar.update(9, {'step': 'Fetching Quotes'});
            ...
            progress_bar.update(10, {'step': 'Quotes Extracted'});
            progress_bar.stop();


            /**
             * EXTRACT THE DATA AND CONSOLE LOG IT
             * @TODO: Extract [Breakdown cover, Courtesy car, Personal accident cover, Motor legal protection, Blackbox quote]
             */
            let data = await page.evaluate(data =>
                Array.from(document.querySelectorAll('li[id*="CarInsurance_YourQuotes_Quotes_"]')).map(q => {
                    return {
            ...
            // data.forEach(q => {
            //     console.log('Quotes');
            //     console.group(q.name);
            //         console.log('Price: ', q.price);
            //         console.group('excess');
            //             q.excesses.forEach(e => console.log(e));
            //         console.groupEnd('excess');
            //         console.log('excess: ', );
            //     console.groupEnd(q.name);
            // });

            if (config.output.detail === 'simple') {
                data = data.map(q => `${q.name} - ${q.price}`);
            } else {
                data = data.map(q => `${q.name} - ${q.price} - E: [${q.excesses.join(' | ')}]`);
            }
